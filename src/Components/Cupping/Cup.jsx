  ...
  return (
    <div className="bg-[#f7f1ea] flex flex-col items-center min-h-screen" style={{minHeight: '120vh'}}>
      ...
      <div className='text-[#567C49] md:text-lg text-[13px] font-light md:ml-[125px] md:mr-[125px] ml-10 mt-[-10px]'>
        <p className='font-bold'>Bellabaci Cupping:</p>
        ...
        <p className='mb-5'>De Detox Voetreflex en Cupping-behandeling is voor iedereen die verlangt naar diepgaande ontspanning, stressvermindering en het stimuleren van het natuurlijke ontgiftingsproces in het lichaam. Het is een heilzame ervaring die niet alleen het lichaam, maar ook de geest koestert, een welverdiende ontsnapping uit het hectische dagelijkse leven.
      </p>
      </div>
    </div>
  );
