...
const Tarieven = () => {
  return (
    ...
    <p className='md:text-[22px] text-md font-semibold'>Bellabaci cupping kuur <span className='md:text-[16px] text-sm font-light'>30 min 7+1 gratis</span><span className='font-bold md:ml-[548px] ml-[70px]'>€520,-</span></p>
    ...
    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light mb-9'>De kuren zijn d.m.v. een Bellabaci tasje (genie + 2 cups, harde en een zachte) en 8 weken lang online begeleiding inclusief 21 video’s E-book en een voortgangskaart t.w.v. €100.</p>
    ...
    <p className='md:text-[22px] text-md font-semibold'>Pedicurebehandeling overige risico voeten <span className='font-bold md:ml-[508px] ml-[57px]'>€50,-</span></p>
    ...
    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light mb-5'>Analyse van de huid, oppervlakte reinigen, dieptereiniging, onzuiverheden verwijderen, eventueel wenkbrauwen bijwerken, klassieke gezichtsmassage*, masker, serum, oogcrème, dag/nacht verzorging</p>
    ...
    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light mb-[100px]'>*Bij schoonheidsbehandelingen is het mogelijk om ipv de klassieke gezichtsmassage een guasha massage of de Japanse gezichtsmassage uit te laten voeren tegen een meerprijs van €12.50.</p>
