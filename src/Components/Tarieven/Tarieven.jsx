...
const Tarieven = () => {
  return (
    ...
    <h1 className='md:text-[66px] text-4xl font-bold text-[#462D10] md:mb-10'>Massage</h1>
      <p className='md:text-[28px] text-lg font-semibold mb-8'>Huid verbeterende massages</p>
      ...
      <p className='md:text-[22px] text-md font-semibold '>Guasha gezichtsmassage <span className='md:text-[16px] text-sm font-light'>(45 minuten)</span><span className='font-bold md:ml-[568px] ml-[80px]'>€60,-</span></p>
      <p className='italic md:text-[16px] text-sm font-light mb-5'>Oppervlakte reiniging / Guasha massage / dag verzorging</p>
      <p className='md:text-[22px] text-md font-semibold '>Japanse gezichtsmassage <span className='md:text-[16px] text-sm font-light'>(45 minuten)</span><span className='font-bold md:ml-[559px] ml-[74px]'>€60,-</span></p>
      <p className='italic md:text-[16px] text-sm font-light mb-5'>Oppervlakte reiniging / Japanse gezichtsmassage / dag verzorging</p>
      <p className='md:text-[22px] text-md font-semibold '>Reiki behandeling <span className='md:text-[16px] text-sm font-light'>(70 minuten)</span><span className='font-bold md:ml-[650px] ml-[140px]'>€80,-</span></p>
      <p className='italic md:text-[16px] text-sm font-light mb-5'>Reiki behandeling</p>
      <p className='md:text-[22px] text-md font-semibold '>Kuurverband massages <span className='md:text-[16px] text-sm font-light'> 5 + 1 behandeling gratis</span><span className='font-bold md:ml-[465px] ml-[6px]'>5 x €60,-</span></p>
      <p className='italic md:text-[16px] text-sm font-light mb-5'>Bindweefsel, Guasha, Japanse gezichtsmassage</p>
      <p className='md:text-[22px] text-md font-semibold '>Kuurverband <span className='md:text-[16px] text-sm font-light'> 5 + 1 behandeling gratis</span><span className='font-bold md:ml-[587px] ml-[94px]'>5 x €60,-</span></p>
      <p className='italic md:text-[16px] text-sm font-light mb-10'>Reiki behandeling</p>
      <p className='text:text-[28px] text-[20px] font-semibold mb-8 text-[#462D10]'>Bellabaci cupping
        <span className='font-bold md:ml-[565px] ml-[65px] md:text-[22px] text-[16px] text-black'>45 min</span>
        <span className='font-bold md:ml-5 ml-2 md:text-[22px] text-[16px] text-black'>60 min</span>
    ...
    <p className='md:text-[22px] text-md font-semibold'>Bellabaci cupping anti-aging </p>
    <p className='md:text-[22px] text-md font-semibold'>Bellabaci cupping stress </p>
    <p className='md:text-[22px] text-md font-semibold mb-[40px]'>Bellabaci cupping buik </p>

    <p className='md:text-[22px] text-md font-semibold'>Bellabaci cupping kuur <span className='md:text-[16px] text-sm font-light'>30 min 7+1 gratis</span><span className='font-bold md:ml-[548px] ml-[70px]'>€440,-</span></p>
    ...
    <span className='font-bold md:ml-[604px] ml-[216px]'>€80,-</span></p>
    <p className='md:text-[22px] text-md font-semibold'>Beauty voetreflexmassage 
    ...
    <p className='md:text-[22px] text-md font-semibold'>Pedicurebehandeling <span className='md:text-[16px] text-sm font-light'>(30-45 minuten)</span><span className='font-bold md:ml-[586px] ml-[95px]'>€45,-</span></p>
    ...
    <p className='md:text-[22px] text-md font-semibold'>Pedicurebehandeling diabetische/reumatische voet</p>
    ...
    <p className='md:text-[22px] text-md font-semibold'>Pedicurebehandeling overige risico voeten</p>
    ...
    <p className='italic md:text-[16px] text-sm font-light mb-[100px]'>*De manicurebehandelingen zijn alleen mogelijk in combinatie met een andere behandeling</p>
    <div className='md:w-[105%] w-[95%] h-[1px] bg-[#023A15] mx-auto my-12'></div>
    ...
    <p className='md:text-[22px] text-md font-semibold'>Huidverbeterende schoonheidsbehandeling plus <span className='md:text-[16px] text-sm font-light'>(90 minuten)</span><span className='font-bold md:ml-[285px] ml-[320px]'>€100,-</span></p>
    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light mb-5'>Analyse van de huid, oppervlakte reinigen, diepte reiniging, onzuiverheden verwijderen, eventueel wenkbrauwen bijwerken, klassieke gezichtsmassage*, masker, serum, oogcrème, dag/nacht verzorging</p>

    <p className='md:text-[22px] text-md font-semibold'>Huidverbeterende schoonheidsbehandeling luxe <span className='md:text-[16px] text-sm font-light'>(90 minuten)</span><span className='font-bold md:ml-[293px] ml-[325px]'>€115,-</span></p>
    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light mb-5'>Analyse van de huid, oppervlakte reinigen, diepte reiniging, onzuiverheden verwijderen, eventueel wenkbrauwen bijwerken, klassieke gezichtsmassage*, ampul, eye patches, peel-off alginaat masker, serum, oogcrème, dag/nacht verzorging</p>

    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light mb-[100px]'>*Bij de twee schoonheidsbehandelingen is het ook mogelijk om ipv de klassieke gezichtsmassage een guasha massage of de Japanse gezichtsmassage uit te laten voeren tegen een meerprijs van €12.50.</p>
    <p className='md:text-[22px] text-md font-semibold mb-[60px]'>Wenkbrauwen epileren <span className='font-bold md:ml-[680px] ml-[180px]'>€12,50</span></p>
    <p className='md:text-[22px] text-md font-semibold'>Bovenlip of kin waxen <span className='font-bold md:ml-[698px] ml-[192px]'>€10,-</span></p>
    <p className='md:text-[22px] text-md font-semibold mb-[60px]'>Bovenlip en kin waxen  <span className='font-bold md:ml-[692px] ml-[188px]'>€18,-</span></p>
    <p className='md:text-[22px] text-md font-semibold'>Wenkbrauwen of wimpers verven <span className='font-bold md:ml-[560px] ml-[92px]'>€12,50</span></p>
    <p className='md:text-[22px] text-md font-semibold mb-[200px]'>Verven wenkbrauwen en wimpers  <span className='font-bold md:ml-[555px] ml-[88px]'>€22,50</span></p>
    </div>
    </div>
  )
}
