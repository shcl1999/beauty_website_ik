...
const Tarieven = () => {
  return (
    ...
    <h1 className='md:text-[66px] text-4xl font-bold text-[#462D10] md:mb-10'>Massage</h1>
      ...
      <p className='md:text-[22px] text-md font-semibold '>Kuurverband <span className='md:text-[16px] text-sm font-light'> 5 + 1 behandeling gratis</span><span className='font-bold md:ml-[587px] ml-[94px]'>5 x €80,-</span></p>
     ...
     <p className='md:text-[22px] text-md font-semibold'>Bellabaci cupping anti-aging
    ...
    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light mb-9'>De cupping kuren zijn inclusief een cuppingset voor thuisgebruik.</p>
    ...
    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light'>Analyse van de huid, oppervlakte reiniging, dieptereiniging, onzuiverheden verwijderen, wenkbrauwen bijwerken</p>
    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light mb-5'>klassieke gezichtsmassage*, masker, serum, oogcrème, dag/nacht verzorging.</p>
    ...
    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light'>Analyse van de huid, oppervlakte reiniging, dieptereiniging, onzuiverheden verwijderen, wenkbrauwen bijwerken</p>
    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light mb-5'>klassieke gezichtsmassage*, ampul, eye patches, peel-off alginaat masker, serum, oogcrème, dag/nacht verzorging.</p> 
    <p className='md:mr-[200px] italic md:text-[16px] text-sm font-light mb-5'>*Bij schoonheidsbehandelingen is het mogelijk om ipv de klassieke gezichtsmassage een guasha massage of de Japanse gezichtsmassage uit te laten voeren tegen een meerprijs van €12.50.</p>
    <p className='md:text-[22px] text-md font-semibold mb-5'>Wenkbrauwen epileren <span className='font-bold md:ml-[680px] ml-[180px]'>€12,50</span></p>
    ...
    <p className='md:text-[22px] text-md font-semibold mb-5'>Bovenlip en kin waxen  <span className='font-bold md:ml-[692px] ml-[188px]'>€18,-</span></p>
    ...
    <p className='md:text-[22px] text-md font-semibold mb-[100px]'>Verven wenkbrauwen en wimpers  <span className='font-bold md:ml-[555px] ml-[88px]'>€22,50</span></p>
    </div>
    </div>
  )
}
